/*
Deployment script for RevalEmpReg
...
GO
:setvar DatabaseName "RevalEmpReg"
:setvar DefaultFilePrefix "RevalEmpReg"
:setvar DefaultDataPath "C:\Users\waaha\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB\"
:setvar DefaultLogPath "C:\Users\waaha\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB\"
...
GO
PRINT N'Creating Procedure [dbo].[spaddEMP]...';
...
AS
	...
	END
GO
PRINT N'Creating Procedure [dbo].[spDeleteEMP]...';
...
AS
	...
	END
GO
PRINT N'Creating Procedure [dbo].[spUpdateEMP]...';
...
AS
	...
	END
GO
PRINT N'Creating Procedure [dbo].[spViewEMP]...';
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '1ea3dacf-bd69-41fb-b0bc-2f92ad80ca4f')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('1ea3dacf-bd69-41fb-b0bc-2f92ad80ca4f')
